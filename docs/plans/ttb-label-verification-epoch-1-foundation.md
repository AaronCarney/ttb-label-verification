...
| 0.4 | 2026-05-03 | Project team | **Post-E1 review correction.** Reverted v0.3 deviation (b): `ApplicationEnvelope.serial_number` `max_length` returned to 6, fixture corrected from `26-0042` to `26-042`. Primary-source check (`docs/research/T2-output.md` Q2.1 row Item 4) confirms TTB Form 5100.31 rev. 04/2023 specifies "year-prefixed sequential, ≤ 6 chars; e.g., '23-1'" — the original fixture value was non-compliant; the T14 deviation bent the schema to fit a wrong fixture rather than the contract. Schema and PRD §6.1 line 392 (`≤ 6 chars, year-prefixed`) are now aligned. 62/62 tests still passing. |
